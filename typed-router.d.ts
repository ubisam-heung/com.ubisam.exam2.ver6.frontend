...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/contents': RouteRecordInfo<'/contents', '/contents', Record<never, never>, Record<never, never>, '/contents/' | '/contents/accounts' | '/contents/repairs' | '/contents/sessions' | '/contents/userAccount'>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/apps/02_bus/pages/contents.vue': {
      routes: '/contents' | '/contents/' | '/contents/accounts' | '/contents/repairs' | '/contents/sessions' | '/contents/userAccount'
      views: 'default'
    }
